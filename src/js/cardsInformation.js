const cards = [
  ['Action (set A)', 'Action (set B)', 'Fruits', 'Tableware', 'Animal (set A)', 'Animal (set B)', 'Clothes', 'Emotions'],
  [{
    word: 'cry',
    translation: 'плакать',
    image: 'img/cry.jpg',
...
const classMainCard = ['Action(setA)', 'Action(setB)', 'Fruits', 'Tableware', 'Animal(setA)', 'Animal(setB)', 'Clothes', 'Emotions']

export { cards, classMainCard }
